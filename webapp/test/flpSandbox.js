					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EDI Upload App",
									"targetURL": "#ediupload-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"ediupload-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ediupload",
									"url": sap.ui.require.toUrl("ediupload")
								}
							}
						}
					}
